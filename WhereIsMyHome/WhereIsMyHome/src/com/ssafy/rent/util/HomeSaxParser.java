...
public class HomeSaxParser {
	...
	private void loadData() {
		...
		String parkingFilePath = "res/ParkingHistory.xml";
		
		try{
			SAXParser parser = factory.newSAXParser();
			HomeSAXHandler handler = new HomeSAXHandler();
			ParkingSAXHandler parking = new ParkingSAXHandler();
			parser.parse(aptInfoFilePath, handler);
			parser.parse(parkingFilePath, parking);
			homeInfo = parking.getParkingInfo(handler.getHomeInfo());
